...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(3435262883302628521)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435263135782628521)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435263461637628521)
,p_page_template_id=>wwv_flow_imp.id(3435262883302628521)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435263714058628521)
,p_page_template_id=>wwv_flow_imp.id(3435262883302628521)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435264041213628522)
,p_page_template_id=>wwv_flow_imp.id(3435262883302628521)
,p_name=>'Body Footer'

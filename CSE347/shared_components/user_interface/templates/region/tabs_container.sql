...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3435364661402628569)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435364916395628570)
,p_plug_template_id=>wwv_flow_imp.id(3435364661402628569)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435365295463628570)
,p_plug_template_id=>wwv_flow_imp.id(3435364661402628569)
,p_name=>'Tabs'

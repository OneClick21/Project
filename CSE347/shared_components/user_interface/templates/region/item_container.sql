...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3435347140168628559)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435347481268628560)
,p_plug_template_id=>wwv_flow_imp.id(3435347140168628559)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435347784373628560)
,p_plug_template_id=>wwv_flow_imp.id(3435347140168628559)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435348016144628560)
,p_plug_template_id=>wwv_flow_imp.id(3435347140168628559)
,p_name=>'Button Start'

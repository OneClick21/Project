...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3435295295393628537)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435295581315628537)
,p_plug_template_id=>wwv_flow_imp.id(3435295295393628537)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435295853417628537)
,p_plug_template_id=>wwv_flow_imp.id(3435295295393628537)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435296106373628537)
,p_plug_template_id=>wwv_flow_imp.id(3435295295393628537)
,p_name=>'Sub Regions'

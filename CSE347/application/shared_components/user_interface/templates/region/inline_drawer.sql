...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3435335089761628554)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435335366855628554)
,p_plug_template_id=>wwv_flow_imp.id(3435335089761628554)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435335625893628554)
,p_plug_template_id=>wwv_flow_imp.id(3435335089761628554)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435335968781628555)
,p_plug_template_id=>wwv_flow_imp.id(3435335089761628554)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435336298404628555)
,p_plug_template_id=>wwv_flow_imp.id(3435335089761628554)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435336565423628555)
,p_plug_template_id=>wwv_flow_imp.id(3435335089761628554)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435336856200628555)
,p_plug_template_id=>wwv_flow_imp.id(3435335089761628554)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435337112913628555)
,p_plug_template_id=>wwv_flow_imp.id(3435335089761628554)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435337453314628555)
,p_plug_template_id=>wwv_flow_imp.id(3435335089761628554)
,p_name=>'Sub Regions'

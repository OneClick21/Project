...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3435349660714628561)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435349974931628561)
,p_plug_template_id=>wwv_flow_imp.id(3435349660714628561)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435350236249628561)
,p_plug_template_id=>wwv_flow_imp.id(3435349660714628561)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435350564516628561)
,p_plug_template_id=>wwv_flow_imp.id(3435349660714628561)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435350875306628561)
,p_plug_template_id=>wwv_flow_imp.id(3435349660714628561)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435351195704628561)
,p_plug_template_id=>wwv_flow_imp.id(3435349660714628561)
,p_name=>'Sub Regions'

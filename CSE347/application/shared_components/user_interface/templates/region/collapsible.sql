...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3435307127647628542)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435307431418628542)
,p_plug_template_id=>wwv_flow_imp.id(3435307127647628542)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435307789609628542)
,p_plug_template_id=>wwv_flow_imp.id(3435307127647628542)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435308082193628542)
,p_plug_template_id=>wwv_flow_imp.id(3435307127647628542)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435308349833628542)
,p_plug_template_id=>wwv_flow_imp.id(3435307127647628542)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435308615756628542)
,p_plug_template_id=>wwv_flow_imp.id(3435307127647628542)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435308999832628542)
,p_plug_template_id=>wwv_flow_imp.id(3435307127647628542)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435309237490628542)
,p_plug_template_id=>wwv_flow_imp.id(3435307127647628542)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435309527163628543)
,p_plug_template_id=>wwv_flow_imp.id(3435307127647628542)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435309868482628543)
,p_plug_template_id=>wwv_flow_imp.id(3435307127647628542)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435310155670628543)
,p_plug_template_id=>wwv_flow_imp.id(3435307127647628542)
,p_name=>'Sub Regions'

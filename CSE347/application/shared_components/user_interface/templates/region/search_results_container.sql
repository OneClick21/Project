...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3435352129881628564)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435352435158628564)
,p_plug_template_id=>wwv_flow_imp.id(3435352129881628564)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435352785469628564)
,p_plug_template_id=>wwv_flow_imp.id(3435352129881628564)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435353001867628564)
,p_plug_template_id=>wwv_flow_imp.id(3435352129881628564)
,p_name=>'Sub Regions'

...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3435321518869628548)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435321815958628548)
,p_plug_template_id=>wwv_flow_imp.id(3435321518869628548)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435322116184628548)
,p_plug_template_id=>wwv_flow_imp.id(3435321518869628548)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435322414133628549)
,p_plug_template_id=>wwv_flow_imp.id(3435321518869628548)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435322760953628549)
,p_plug_template_id=>wwv_flow_imp.id(3435321518869628548)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435323054626628549)
,p_plug_template_id=>wwv_flow_imp.id(3435321518869628548)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false

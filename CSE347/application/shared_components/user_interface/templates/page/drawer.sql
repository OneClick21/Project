...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(3435252220134628514)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435252523088628515)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435252842597628515)
,p_page_template_id=>wwv_flow_imp.id(3435252220134628514)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435253190277628515)
,p_page_template_id=>wwv_flow_imp.id(3435252220134628514)

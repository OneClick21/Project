...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(3435274340225628527)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435274680817628527)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435274943989628527)
,p_page_template_id=>wwv_flow_imp.id(3435274340225628527)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435275258117628527)
,p_page_template_id=>wwv_flow_imp.id(3435274340225628527)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435275533053628527)
,p_page_template_id=>wwv_flow_imp.id(3435274340225628527)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435275840751628528)
,p_page_template_id=>wwv_flow_imp.id(3435274340225628527)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435276183254628528)
,p_page_template_id=>wwv_flow_imp.id(3435274340225628527)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435276467250628528)
,p_page_template_id=>wwv_flow_imp.id(3435274340225628527)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435276771380628528)
,p_page_template_id=>wwv_flow_imp.id(3435274340225628527)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435277040279628528)
,p_page_template_id=>wwv_flow_imp.id(3435274340225628527)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435277386588628528)
,p_page_template_id=>wwv_flow_imp.id(3435274340225628527)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435277637769628528)
,p_page_template_id=>wwv_flow_imp.id(3435274340225628527)

...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(3435281491819628530)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435281774522628530)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435282016386628530)
,p_page_template_id=>wwv_flow_imp.id(3435281491819628530)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435282371935628530)
,p_page_template_id=>wwv_flow_imp.id(3435281491819628530)

...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(3435272806422628526)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435273168151628526)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435273449439628527)
,p_page_template_id=>wwv_flow_imp.id(3435272806422628526)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3435273754220628527)
,p_page_template_id=>wwv_flow_imp.id(3435272806422628526)

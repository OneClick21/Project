					...
					<div class="sign__content">
						...
						<form class="sign__form" method="post">
							...
							<div class="sign__group">
								<input type="text" class="sign__input" placeholder="Name" name="name" requried>
							</div>

							<div class="sign__group">
								<input type="email" class="sign__input" placeholder="Email" name="email" requried>
							</div>

							<div class="sign__group">
								<input type="password" class="sign__input" placeholder="Password" name="pass" requried>
							</div>

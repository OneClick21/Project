			...
			if ($row = mysqli_fetch_assoc($result)) {
				...
				<div class="container">
					<div class="row">
							...
							<div class="card card--details">
								<div class="row">
									<div class="col-12 col-sm-5 col-md-4 col-lg-3 col-xl-5">
										...
										<a href="<?php echo $row['link']; ?>" target="_blank" class="card_trailer"
											style="color:white;"><i class="icon ion-ios-play-circle"></i> Watch trailer</a>
									</div>
									<div class="col-12 col-md-8 col-lg-9 col-xl-7">
										<div class="card__content">
											<ul class="card__meta">
												<li><span>Director:</span><?php echo $row['director']; ?></li>
												<li><span>Cast:</span><?php echo $row['cast']; ?></li>
												<li><span>Genre:</span><i
														style="color: #f9ab00"><?php echo $row['genre']; ?></i>
												</li>
												<li><span>Release year:</span><?php echo $row['release_year']; ?></li>
												<li><span>Running time:</span><?php echo $row['runtime']; ?> minutes</li>
											</ul>
										</div>
									</div>
								</div>
						...
						<div class="col-12 col-xl-6">
							<span><b style="color: #f9ab00">Description:</b></span>
				...
				echo "<center><h1 style='color: white'>Movie not found</h1></center>";
			}
		} else {
			echo "<center><h1 style='color: white'>Invalid movie ID</h1></center>";
		}
		?>
	</section>
								...
								<div class="col-12">
									<div class="comments">
											...
											while ($rowxx = mysqli_fetch_array($resultxx)) {
												...
												<li class="comments__item">
													<div class="comments__autor">
														...
														<span class="comments__name">Username:
															<?php echo $rowxx['c_username']; ?></span>

														<span class="comments__title"
															style="color:white;"><?php echo $rowxx['c_title']; ?></span>
										...
										<form method="post">
											...
											<input type="submit" class="form__btn" name="sub1">
										</form>
									</div>
								</div>
								<!-- end comments -->
								...
								<div class="col-12">
									<div class="reviews">
											...
											while ($rowx = mysqli_fetch_array($resultx)) {
												...
												<li class="reviews__item">
													<div class="reviews__autor">
														...
														<span class="reviews__name">Movie Title :
															<?php echo $rowx['title']; ?></span>
														<span class="reviews__name" style="color:white">Username :
															<?php echo $rowx['u_name']; ?></span>

														<span
															class="reviews__time"><?php echo $rowx['review_time']; ?></span>

														<span
															class="reviews__rating reviews__rating--green"><?php echo $rowx['rating']; ?></span>
													</div>
										...
										<form method="post">
											...
											<textarea class="form__textarea" placeholder="Review"
												name="review"></textarea>
											<div class="form__slider">
												<input type="range" class="form__slider-rating" id="slider__rating"
											...
											<input type="submit" class="form__btn" name="sub2">
										</form>
										...
										foreach ($files as $file) {
											...
											if ($file !== "." && $file !== "..") {
												...
												<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
													<a href="<?php echo $uploadDir . '/' . $file; ?>" itemprop="contentUrl"
														data-size="1920x1280">
														<img src="<?php echo $uploadDir . '/' . $file; ?>" alt="Image description"
															itemprop="thumbnail">
													</a>
				...
				<div class="col-12 col-lg-12 col-xl-4">
					<div class="row row--grid">
						...
						<div class="col-6 col-sm-4 col-lg-6">
							...
							$sql = "SELECT * FROM `recom` where title = '$title'";
							$relt = mysqli_query($conn, $sql);
							$row1 = mysqli_fetch_array($relt);
							$recommendations = array($row1['recom1'], $row1['recom2'], $row1['recom3']);

							foreach ($recommendations as $recommendation) {
								$sql = "SELECT * FROM `admin_add_item_movies` WHERE title = '$recommendation'";


								// $sql = "SELECT * FROM `admin_add_item_movies` where title = '$row2'";
								$result = mysqli_query($conn, $sql);
								while ($row = mysqli_fetch_array($result)) {
									?>
									<div class="card">
										<div class="card__cover" style="height: 190px;  width:140px;">
											<a href="details.php?movie_id=<?php echo $row['id']; ?>">

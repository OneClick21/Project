  ...
  <div class="sidebar">
    ...
    <div class="sidebar__nav-wrap">
      <ul class="sidebar__nav">
        ...
        <li class="sidebar__nav-item">
          <a href="users.php" class="sidebar__nav-link sidebar__nav-link--active"><i class="icon ion-ios-contacts"></i>
            <span>Users</span></a>
        </li>

        <li class="sidebar__nav-item">
          <a href="comments.php" class="sidebar__nav-link sidebar__nav-link"><i class="icon ion-ios-star-half"></i>

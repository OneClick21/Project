	...
	<div class="sidebar">
		...
		<div class="sidebar__nav-wrap">
			<ul class="sidebar__nav">
				...
				<li class="sidebar__nav-item">
					<a href="" class="sidebar__nav-link"><i class="icon ion-ios-arrow-round-back"></i> <span>Back to HotFlix</span></a>
				</li>
			</ul>
		</div>
		<!-- end sidebar nav -->
			...
			<div class="row">
				...
				<div class="col-12">
					<div class="main__title">
						...
						$sql9 = "SELECT COUNT(*) AS movie_count FROM `admin_add_item_movies` ";
							...
							<tbody>
								...
								?>
									...
									<tr>
										...
										<td>
											<div class="main__table-text main__table-text--rate"><i class="icon ion-ios-star"></i> <?php echo $row[10] ?></div>
										</td>
										<td>

        ...
        <div class="sidebar__nav-wrap">
            <ul class="sidebar__nav">
                <li class="sidebar__nav-item">
                    <a href="index.php" class="sidebar__nav-link"><i class="icon ion-ios-keypad"></i>
                ...
                <li class="sidebar__nav-item">
                    <a href="comments.php" class="sidebar__nav-link "><i class="icon ion-ios-star-half"></i>
                        <span>Comments</span></a>
                </li>


                <li class="sidebar__nav-item">
                    <a href="reviews.php" class="sidebar__nav-link sidebar__nav-link--active"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="main__table-text main__table-text--rate"><i
                                                class="icon ion-ios-star"></i> <?php echo $row[4] ?></div>
                                    </td>
                                    <td>
    ...
    while ($rowsss = mysqli_fetch_array($resultss)) {
        ...
        <div id="modal-delete-<?php echo $review_id; ?>" class="zoom-anim-dialog mfp-hide modal">
            ...
            <div class="modal__btns">
                <a href="delreview.php?id=<?php echo $review_id; ?>" class="modal__btn modal__btn--apply"
        ...
        <div id="modal-edit-<?php echo $review_id; ?>" class="zoom-anim-dialog mfp-hide modal">
            ...
            <div class="modal__btns">
                <a href="edit_reviews.php?id=<?php echo $review_id; ?>" class="modal__btn modal__btn--apply"
                    type="button">Edit</a>
                <button class="modal__btn modal__btn--dismiss" type="button">Dismiss</button>
            </div>
        </div>

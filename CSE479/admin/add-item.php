...
if (isset($_POST['sub'])) {
	...
	$sql = "INSERT INTO `admin_add_item_movies`(`cover`, `title`, `director`, `cast`, `description`, `release_year`, `runtime`, `rating`, `genre`, `link`)
	VALUES ('$cover', '$title', '$director', '$cast', '$description', '$releaseYear', '$runtime', '$rating', '$genres', '$movielink')";
	...
	<div class="sidebar">
		...
		<div class="sidebar__nav-wrap">
			<ul class="sidebar__nav">
				...
				<li class="sidebar__nav-item">
					<a href="" class="sidebar__nav-link"><i class="icon ion-ios-arrow-round-back"></i> <span>Back to CineFlix</span></a>
				</li>
			</ul>
		</div>
		<!-- end sidebar nav -->

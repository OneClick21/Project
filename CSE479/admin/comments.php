	...
	<div class="sidebar">
		...
		<div class="sidebar__nav-wrap">
			<ul class="sidebar__nav">
				...
				<li class="sidebar__nav-item">
					<a href="comments.php" class="sidebar__nav-link sidebar__nav-link--active"><i
								...
								<tr>
									...
									<td>
										<div class="main__table-btns">
											...
											<a href="#modal-edit-<?= $comment_id; ?>"
												class="main__table-btn main__table-btn--edit open-modal">
												<i class="icon ion-ios-create"></i>
											</a>
											<a href="#modal-delete-<?= $comment_id; ?>"
	...
	while ($rowsss = mysqli_fetch_array($resultss)) {
		...
		<div id="modal-delete-<?php echo $comment_id; ?>" class="zoom-anim-dialog mfp-hide modal">
			...
			<div class="modal__btns">
				<a href="del.php?id=<?php echo $comment_id; ?>" class="modal__btn modal__btn--apply"
		...
		<div id="modal-edit-<?php echo $comment_id; ?>" class="zoom-anim-dialog mfp-hide modal">
			...
			<div class="modal__btns">
				<a href="editcoments.php?id=<?php echo $comment_id; ?>" class="modal__btn modal__btn--apply"
					type="button">Edit</a>
				<button class="modal__btn modal__btn--dismiss" type="button">Dismiss</button>
			</div>
		</div>

...
include ('conn.php');
$e = $_SESSION['e'];
$sql = "SELECT * FROM `admin_signup` WHERE `a_email`='$e' AND active = 1";
		...
		<div class="sidebar__nav-wrap">
			<ul class="sidebar__nav">
				<li class="sidebar__nav-item">
					<a href="index.php" class="sidebar__nav-link sidebar__nav-link--active"><i
							class="icon ion-ios-keypad"></i> <span>Dashboard</span></a>
				</li>

				<li class="sidebar__nav-item">
					<a href="catalog.php" class="sidebar__nav-link"><i class="icon ion-ios-film"></i>
						<span>Catalog</span></a>
				</li>

				<!-- collapse -->
				<li class="sidebar__nav-item">
					<a href="add-item.php" class="sidebar__nav-link"><i class="icon ion-ios-keypad"></i>
						<span>Add item</span></a>
				</li>
				<!-- end collapse -->

				<li class="sidebar__nav-item">
					<a href="users.php" class="sidebar__nav-link"><i class="icon ion-ios-contacts"></i>
						<span>Users</span></a>
				</li>

				<li class="sidebar__nav-item">
					<a href="comments.php" class="sidebar__nav-link sidebar__nav-link"><i
							class="icon ion-ios-star-half"></i> <span>Comments</span></a>
				</li>
				<li class="sidebar__nav-item">
					<a href="reviews.php" class="sidebar__nav-link"><i class="icon ion-ios-star-half"></i>
						<span>Reviews</span></a>
				</li>
				<li class="sidebar__nav-item">
					<a href="" class="sidebar__nav-link"><i class="icon ion-ios-arrow-round-back"></i> <span>Back to
							cineFlix</span></a>
				</li>
			...
			<div class="row row--grid">
				...
				<div class="col-12 col-sm-6 col-lg-3">
					<div class="stats">
						...
						$sqla = "SELECT COUNT(*) AS movie_count FROM `admin_add_item_movies` ";
								...
								<tbody>
									...
									while ($row9 = mysqli_fetch_array($result9)) {
										...
										<tr>
											...
											<td>
												<div class="main__table-text"><a href="#"><?php echo $row9['title'] ?></a>
												</div>
											</td>
											<td>
											...
											<td>
												<div class="main__table-text main__table-text--rate"><i
														class="icon ion-ios-star"></i><?php echo $row9['rating'] ?></div>
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												<div class="main__table-text"><a
														href="#"><?php echo $roww['c_username'] ?></a></div>
											</td>
											<td>
								...
								<tbody>
									...
									while ($row = mysqli_fetch_array($result)) {
										...
										<tr>
											...
											<td>
												<div class="main__table-text"><a href="#"><?php echo $row['u_name'] ?></a>
												</div>
											</td>
											<td>
								...
								<tbody>
									...
									while ($row = mysqli_fetch_array($result)) {
										...
										<tr>
											...
											<td>
												<div class="main__table-text main__table-text--rate"><i
														class="icon ion-ios-star"></i> <?php echo $row[3] ?></div>
											</td>
										</tr>

                    ...
                    <form class="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row row--form">
                                <div class="col-12 col-sm-6 col-md-12">
                                    <div class="form__img">
                                        ...
                                        <img id="form__img" src="#"  value=" <?php echo $fetch[1] ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-7 form__content">
                            <div class="row row--form">
                                ...
                                <div class="col-12 col-sm-6 col-lg-3">
                                    <input type="text" class="form__input" name="rating" placeholder="Rating" value="<?php echo $fetch[11]; ?>">
                                </div>
                                <div class="col-12 col-lg-6">
                                    <input type="text" class="form__input" name="genre" placeholder="Genre" value="<?php echo $fetch[8] ?>">
                                </div>

                                <div class="col-12">
                                    <input type="text" class="form__input" placeholder="Or add a link" name="link" value="<?php echo $fetch[10] ?>">
                                </div>

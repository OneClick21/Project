...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62248890505314566279)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248890801156566280)
,p_plug_template_id=>wwv_flow_imp.id(62248890505314566279)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248891138772566280)
,p_plug_template_id=>wwv_flow_imp.id(62248890505314566279)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248891492995566280)
,p_plug_template_id=>wwv_flow_imp.id(62248890505314566279)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248891729524566280)
,p_plug_template_id=>wwv_flow_imp.id(62248890505314566279)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248892097898566280)
,p_plug_template_id=>wwv_flow_imp.id(62248890505314566279)
,p_name=>'Sub Regions'

...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62248865816970566269)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248866155827566269)
,p_plug_template_id=>wwv_flow_imp.id(62248865816970566269)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248866429814566269)
,p_plug_template_id=>wwv_flow_imp.id(62248865816970566269)
,p_name=>'Sub Regions'

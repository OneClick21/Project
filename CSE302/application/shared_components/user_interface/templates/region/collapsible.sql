...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62248847953188566261)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248848271376566261)
,p_plug_template_id=>wwv_flow_imp.id(62248847953188566261)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248848558445566261)
,p_plug_template_id=>wwv_flow_imp.id(62248847953188566261)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248848896418566262)
,p_plug_template_id=>wwv_flow_imp.id(62248847953188566261)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248849170997566262)
,p_plug_template_id=>wwv_flow_imp.id(62248847953188566261)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248849415840566262)
,p_plug_template_id=>wwv_flow_imp.id(62248847953188566261)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248849710675566262)
,p_plug_template_id=>wwv_flow_imp.id(62248847953188566261)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248850017249566262)
,p_plug_template_id=>wwv_flow_imp.id(62248847953188566261)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248850362001566262)
,p_plug_template_id=>wwv_flow_imp.id(62248847953188566261)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248850673657566262)
,p_plug_template_id=>wwv_flow_imp.id(62248847953188566261)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248850919220566262)
,p_plug_template_id=>wwv_flow_imp.id(62248847953188566261)
,p_name=>'Sub Regions'

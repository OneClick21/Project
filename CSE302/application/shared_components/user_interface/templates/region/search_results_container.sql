...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62248893014003566281)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248893355292566281)
,p_plug_template_id=>wwv_flow_imp.id(62248893014003566281)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248893665269566281)
,p_plug_template_id=>wwv_flow_imp.id(62248893014003566281)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248893958303566281)
,p_plug_template_id=>wwv_flow_imp.id(62248893014003566281)
,p_name=>'Sub Regions'

...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62248888074697566278)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248888366575566279)
,p_plug_template_id=>wwv_flow_imp.id(62248888074697566278)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248888610777566279)
,p_plug_template_id=>wwv_flow_imp.id(62248888074697566278)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248888928468566279)
,p_plug_template_id=>wwv_flow_imp.id(62248888074697566278)
,p_name=>'Button Start'

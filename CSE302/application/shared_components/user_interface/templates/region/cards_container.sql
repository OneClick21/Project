...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62248836173397566257)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248836424652566257)
,p_plug_template_id=>wwv_flow_imp.id(62248836173397566257)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248836724465566257)
,p_plug_template_id=>wwv_flow_imp.id(62248836173397566257)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248837089641566257)
,p_plug_template_id=>wwv_flow_imp.id(62248836173397566257)
,p_name=>'Sub Regions'

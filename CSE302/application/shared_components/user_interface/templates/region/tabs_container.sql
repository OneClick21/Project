...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62248905567954566286)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248905836435566286)
,p_plug_template_id=>wwv_flow_imp.id(62248905567954566286)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248906199067566286)
,p_plug_template_id=>wwv_flow_imp.id(62248905567954566286)
,p_name=>'Tabs'

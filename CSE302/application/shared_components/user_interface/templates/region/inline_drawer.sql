...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62248875953611566273)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248876295321566273)
,p_plug_template_id=>wwv_flow_imp.id(62248875953611566273)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248876579527566273)
,p_plug_template_id=>wwv_flow_imp.id(62248875953611566273)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248876818773566273)
,p_plug_template_id=>wwv_flow_imp.id(62248875953611566273)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248877194248566273)
,p_plug_template_id=>wwv_flow_imp.id(62248875953611566273)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248877458731566274)
,p_plug_template_id=>wwv_flow_imp.id(62248875953611566273)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248877710762566274)
,p_plug_template_id=>wwv_flow_imp.id(62248875953611566273)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248878048117566274)
,p_plug_template_id=>wwv_flow_imp.id(62248875953611566273)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248878362695566274)
,p_plug_template_id=>wwv_flow_imp.id(62248875953611566273)
,p_name=>'Sub Regions'

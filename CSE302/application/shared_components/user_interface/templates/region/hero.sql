...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62248862383302566267)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248862600643566267)
,p_plug_template_id=>wwv_flow_imp.id(62248862383302566267)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248862989010566268)
,p_plug_template_id=>wwv_flow_imp.id(62248862383302566267)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248863294656566268)
,p_plug_template_id=>wwv_flow_imp.id(62248862383302566267)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248863549986566268)
,p_plug_template_id=>wwv_flow_imp.id(62248862383302566267)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248863885918566268)
,p_plug_template_id=>wwv_flow_imp.id(62248862383302566267)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false

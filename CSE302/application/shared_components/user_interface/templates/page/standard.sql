...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(62248818965217566249)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248819240578566249)
,p_page_template_id=>wwv_flow_imp.id(62248818965217566249)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248819546048566249)
,p_page_template_id=>wwv_flow_imp.id(62248818965217566249)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248819832460566249)
,p_page_template_id=>wwv_flow_imp.id(62248818965217566249)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248820157613566250)
,p_page_template_id=>wwv_flow_imp.id(62248818965217566249)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248820471148566250)
,p_page_template_id=>wwv_flow_imp.id(62248818965217566249)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248820741347566250)
,p_page_template_id=>wwv_flow_imp.id(62248818965217566249)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248821096368566250)
,p_page_template_id=>wwv_flow_imp.id(62248818965217566249)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248821373354566250)
,p_page_template_id=>wwv_flow_imp.id(62248818965217566249)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248821624534566250)
,p_page_template_id=>wwv_flow_imp.id(62248818965217566249)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248821922731566250)
,p_page_template_id=>wwv_flow_imp.id(62248818965217566249)

...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(62248803709013566242)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248804068445566242)
,p_page_template_id=>wwv_flow_imp.id(62248803709013566242)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248804345125566242)
,p_page_template_id=>wwv_flow_imp.id(62248803709013566242)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248804680743566242)
,p_page_template_id=>wwv_flow_imp.id(62248803709013566242)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248804919289566243)
,p_page_template_id=>wwv_flow_imp.id(62248803709013566242)
,p_name=>'Body Footer'

...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(62248822305746566250)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248822694684566251)
,p_page_template_id=>wwv_flow_imp.id(62248822305746566250)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248822931666566251)
,p_page_template_id=>wwv_flow_imp.id(62248822305746566250)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248823261247566251)
,p_page_template_id=>wwv_flow_imp.id(62248822305746566250)

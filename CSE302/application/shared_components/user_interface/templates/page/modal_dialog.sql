...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(62248813793361566247)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248814018911566247)
,p_page_template_id=>wwv_flow_imp.id(62248813793361566247)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248814364839566247)
,p_page_template_id=>wwv_flow_imp.id(62248813793361566247)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248814687453566247)
,p_page_template_id=>wwv_flow_imp.id(62248813793361566247)

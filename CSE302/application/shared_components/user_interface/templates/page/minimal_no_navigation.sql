...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(62248810381173566245)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248810674760566245)
,p_page_template_id=>wwv_flow_imp.id(62248810381173566245)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248810939511566246)
,p_page_template_id=>wwv_flow_imp.id(62248810381173566245)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248811248563566246)
,p_page_template_id=>wwv_flow_imp.id(62248810381173566245)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248811588088566246)
,p_page_template_id=>wwv_flow_imp.id(62248810381173566245)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248811858360566246)
,p_page_template_id=>wwv_flow_imp.id(62248810381173566245)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248812171113566246)
,p_page_template_id=>wwv_flow_imp.id(62248810381173566245)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248812483853566246)
,p_page_template_id=>wwv_flow_imp.id(62248810381173566245)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248812710469566246)
,p_page_template_id=>wwv_flow_imp.id(62248810381173566245)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248813063894566246)
,p_page_template_id=>wwv_flow_imp.id(62248810381173566245)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62248813373530566246)
,p_page_template_id=>wwv_flow_imp.id(62248810381173566245)
